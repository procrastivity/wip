...
// whatever it finds and writes the stamp unconditionally — refusing to
// overwrite a hand-edited or unstamped target is the `wip install` verb's
// job (internal/harness.RefuseHandEdited), not this function's, kept out
// of Install so every harness stays policy-free and so a caller that has
