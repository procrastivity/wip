...
// rootDir returns Codex's own root config directory under home, ~/.codex —
// the directory both SkillsDir and Available key off of.
...
// host: its root config directory (~/.codex) exists, or — when SkillsDirEnv
